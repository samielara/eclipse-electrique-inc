      ...
      <div className="w-full max-w-[1720px] mx-auto px-3 sm:px-5 lg:px-6 xl:px-8">
        <div className="text-center max-w-2xl mx-auto mb-8">
          ...
          <p className="text-slate-400 text-xs sm:text-sm md:text-base">
            {isFrench
              ? "De votre premier contact jusqu'à la conformité finale, notre parcours est fluide, transparent et sécurisé."
              : "From your first contact to final code inspection, our process is transparent, punctual, and seamless."}
          </p>
        </div>
